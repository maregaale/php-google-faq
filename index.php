      ...
      <?php for ($i=0; $i < count($questions); $i++) { ?>
        ...
        <?php if ($i != 2) { ?>
          <?php for ($j = 0; $j < count($answers[$i]); $j++) { ?>
            <p> <?php echo $answers[$i][$j]; ?> </p>
          <?php } ?>
        <?php } elseif ($i = 2) { ?> 
          <!-- stampa particolare risposta con liste -->

          <!-- considerazione 1 -->
          <p> <?php echo $answers[$i]["consid_1"]; ?> </p>
          <!-- 7considerazione 1 -->

          <!-- considerazione 2: prima lista -->
          <ol> 
            <li>
              <?php echo $answers[$i]["consid_2"]["1"][0]; ?> 

              <!-- seconda lista -->
              <ol class="alpha">
                <li>
                  <?php echo $answers[$i]["consid_2"]["1"][1]; ?> 
                </li>
                <li>
                  <?php echo $answers[$i]["consid_2"]["1"][2]; ?> 
                </li>
              </ol>  
              <!-- /seconda lista -->
            </li>
            ...
            <li>
              <?php echo $answers[$i]["consid_2"]["2"]; ?>
            </li>
          </ol>
          <!-- /considerazione 2: prima lista -->

          <!-- considerazione 3 -->
          <p> <?php echo $answers[$i]["consid_3"]; ?> </p>
          <!-- /considerazione 3 -->

          <!-- considerazione 4 -->
          <h3> <?php echo $answers[$i]["consid_4"]; ?> </h3>
          <!-- considerazione 4 -->

          <!-- considerazione 5 -->
          <?php foreach ($answers[$i]["consid_5"] as $el) { ?>
            <p> <?php echo $el; ?> </p>
          <?php } ?>
          <!-- considerazione 5 -->
        <?php } ?>
